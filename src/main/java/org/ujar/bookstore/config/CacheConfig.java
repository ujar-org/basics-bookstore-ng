...
class CacheConfig {
  ...
  JCacheManagerCustomizer cacheManagerCustomizer() {
    return cm -> {
      createCache(cm, org.ujar.bookstore.entity.Product.class.getName());
      createCache(cm, org.ujar.bookstore.entity.ProductCategory.class.getName());
      createCache(cm, org.ujar.bookstore.entity.GeoCountry.class.getName());
      createCache(cm, org.ujar.bookstore.entity.GeoState.class.getName());
      createCache(cm, org.ujar.bookstore.entity.Address.class.getName());
      createCache(cm, org.ujar.bookstore.entity.Customer.class.getName());
      createCache(cm, org.ujar.bookstore.entity.Order.class.getName());
      createCache(cm, org.ujar.bookstore.entity.OrderItem.class.getName());
    };
  }
